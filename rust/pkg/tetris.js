...
export class Game {
     ...
     */
    update(time) {
        wasm.game_update(this.__wbg_ptr, time);
    }
    toggle_pause() {
    ...
    handle_key(key) {
        ...
        wasm.game_handle_key(this.__wbg_ptr, ptr0, len0);
    }
    update_score() {
        wasm.game_update_score(this.__wbg_ptr);
    }
    check_game_over() {
        wasm.game_check_game_over(this.__wbg_ptr);
    }
    /**
     * @param {string} scheme
     */
    set_color_scheme(scheme) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_set_color_scheme(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    set_background_color(color) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_set_background_color(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    get_background_names() {
        const ret = wasm.game_get_background_names(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} name
     ...
     */
    get_background_path(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_get_background_path(this.__wbg_ptr, ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
    ...
    set_background(background) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_set_background(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
